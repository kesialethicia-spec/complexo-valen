  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center bg-muted/40 px-4 py-16">
      <div className="w-full max-w-md rounded-2xl border bg-card p-8 shadow-lg">
        ...
        <h1 className="mt-4 text-2xl font-display font-bold">Acesso administrativo</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Entre com seu e-mail e senha. O acesso é restrito a administradores autorizados.
        </p>
